...
/-- Name-stable alias for the unified-system functor table: a β-simulation “soundness” theorem
for the bracket abstraction compiler. -/
theorem bracket_sound (ρ : Var → Comb) (x : Var) (e : CExp Var) (v : Comb) :
    ∃ r : Comb, Comb.Steps (Comb.app (denote ρ (bracket x e)) v) r ∧
      Comb.Steps (denote (update ρ x v) e) r := by
